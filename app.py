...
st.write("Les genres de films disponibles dans la bases", q5(db))
st.write("Le film qui a généré le plus de revenu est ", q6(db)['title'], "avec ",q6(db)['revenue'], "millions de revenus." )
